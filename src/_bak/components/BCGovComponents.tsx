...
const PageHeader: React.FC = () => {
  ...
  return (
    <div>
      ...
      logoImage={<img src="https://raw.githubusercontent.com/MichaelDykesBC/michaeldykesbc.github.io/refs/heads/master/docs/assets/GeoBC_text_blue_150px.png" 
      alt="GeoBC Logo" 
      style={{ height: "30px" }} />} 
      children={
...
const PageFooter: React.FC = () => {
  ...
  return (
    <div>
      <Footer
        hideAcknowledgement = {Boolean(isMapPage)}
        hideLogoAndLinks = {Boolean(isMapPage)}
      />
    </div>
  );
};
